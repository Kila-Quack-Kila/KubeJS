...
public class REIPlugin implements REIClientPlugin {
	private final Set<CategoryIdentifier<?>> categoriesYeeted = new HashSet<>();
	...
	public void registerDisplays(DisplayRegistry registry) {
		...
		registry.registerVisibilityPredicate((category, display) -> {
			return categoriesYeeted.contains(category.getCategoryIdentifier()) ? EventResult.interruptFalse() : EventResult.pass();
		});
	}
