...
public class KubeJSEntityEventHandler {
	public static void init() {
		...
		EntityEvent.LIVING_HURT.register(KubeJSEntityEventHandler::livingAttack);
	...
	private static EventResult livingAttack(LivingEntity entity, DamageSource source, float amount) {
